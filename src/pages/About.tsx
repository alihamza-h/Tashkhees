      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full max-w-7xl mx-auto">
        ...
        >
          ...
          <img
            ...
            className="relative rounded-2xl shadow-2xl border border-blue-700/50"
          />

          <div className="absolute -bottom-6 -left-6 bg-blue-950 p-6 rounded-xl border border-blue-700 shadow-xl max-w-xs">
            <div className="flex items-center gap-4 mb-2">
              <Award className="w-8 h-8 text-yellow-400" />
              <span className="font-bold text-lg">Award Winning</span>
            </div>
            <p className="text-sm text-blue-300">Recognized for excellence in AI innovation and implementation.</p>
          </div>
        </motion.div>
